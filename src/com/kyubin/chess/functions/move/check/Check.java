...
public class Check {
    public static int checkCount(boolean is_white,boolean no_repeat) {
        ...
        if(is_white){
            pieces=BasicFunctions.addAllNotKing(ChessGame.white_rook, ChessGame.white_knight, ChessGame.white_bishop, ChessGame.white_queen,
                    ChessGame.white_pawn);
        } else {
            pieces=BasicFunctions.addAllNotKing(ChessGame.black_rook, ChessGame.black_knight, ChessGame.black_bishop, ChessGame.black_queen,
                    ChessGame.black_pawn);
        }
    ...
    private static boolean canAttackKing(Piece piece, XY kingPosition, boolean no_repeat) {
        ...
        for(XY xy:moves){
            if(xy.equals(kingPosition)){is_check=true; break;}
        }
